...
class DeviceTextInput extends StatefulWidget {
  ...
  @override
  State<DeviceTextInput> createState() => _DeviceTextInputState();
}

class _DeviceTextInputState extends State<DeviceTextInput> {
  bool _obscure = true;
